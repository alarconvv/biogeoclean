...
#title: 'biogeoclean: An R package to cleaning geographical data from electronic biodatabases'
...
_**biogeoclean**_ is a cleaning protocol for distributional data and an
...
## **1.0** A worked example for *biogeoclean* package (R-Alarcon and Miranda-Esquivel, submitted)
...
Then, we get the latest version of _**biogeoclean**_ from GitHub repository, and load the 
library:
...
library('devtools')	
#install_github('alarconvv/biogeoclean', dependencies = TRUE)	
library('biogeoclean')	
...
All the files imported or exported from _**biogeoclean**_ follow the headers
